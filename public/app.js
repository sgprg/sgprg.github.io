...
copy?.addEventListener('click', async () => {
  try {
    ...
    setTimeout(() => { copy.textContent = 'Copy email address'; }, 2500);
  } catch {
    document.querySelector('#copy-status').textContent = 'Copy unavailable. Select the email address above to copy it, or open it to write an email.';
